...
<head>
    ...
    <title>BTC - 2022 - IEEE Bangalore Section</title>
                        ...
                        <div class="col-xl-9 col-md-6 xol-sm-6">
                            <div class="title_text">
                                ...
                                <div class="single_date">
                                    <span>Clean Technologies for a Sustainable World</span>
                                </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-xl-5 offset-xl-1 col-md-6">
                    <div class="about_info">
                        ...
                        <p>IEEE BTC 2022 is a flagship event of IEEE Bangalore Section, organized in collaboration with 
                            ...
                            and living.<br><br>
                            This edition of IEEE BTC will be based on the theme of Metaverse with a specific focus on:<br>
                            <ul>
                                <li>AR/VR/XR</li>
